# / search n to next N to revious
# %s/a/b/g replace all a with b (add c at the end to ask confirmation

# :buffers to see how many buffers
# :buffer 

# ctrl + C stop a bash command running
# ctrl + d close the shell
# ctrl + l clear the terminal
# ctrl + a to the start of the line and e to the end
# alt + f or b to go between words
# ctrl + r to research past command with string and apply them

## VimR ##  https://github.com/jalvesaq/Nvim-R/blob/master/doc/Nvim-R.txt
# \rf to lauch r in vim
# \rq to close
# \l to lauch line
# \aa to lauch file
# \bb block
...
minesweeper <- function(N=20,X=20,Y=20, verbose = FALSE){ # N number of bomb, X and Y the size of the map
