...
Feel free to participate to this project, it is designed to be open source under a [CECILL-2 Licence](https://github.com/gowachin/DiveR/blob/master/LICENCE-CECILL-2.1.txt). 
...
Below is a simple example to simulate a dive and the corresponding air consumption.
