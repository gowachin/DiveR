...
#' population curve, NOT on the capacity line (custom parameter need 
#' to be given, as exemple capacity_lty).
#' \itemize{
...
#'   \item \strong{ylab} set to \code{'Size'} by default, 
#'   see \code{\link[graphics]{title}}.
#'   \item \strong{main} set to use the pop label by default, 
#'   see \code{\link[graphics]{title}}.
#'   }
#' @param text_print set to \code{TRUE} by default, whether there is a text 
#' on the capacipty line or not (writting population 'K label' by default).
#' @param add set to \code{FALSE} by default, to add another population plot 
#' on a precedent one.
#' 
#' @seealso
#' \itemize{
